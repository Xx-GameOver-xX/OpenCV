...
landmarks1 = Finde_Landmarks(image1)
image_with_landmarks1 = annotate_landmarks(image1, landmarks1)

cv2.imshow('Result 1:', image_with_landmarks1)

landmarks2 = Finde_Landmarks(image2)
image_with_landmarks2 = annotate_landmarks(image2, landmarks2)

cv2.imshow('Result 2:', image_with_landmarks2)
